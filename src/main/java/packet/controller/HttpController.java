...
import packet.control.Event;
import packet.control.EventBus;
import packet.model.DemoInfo;
import packet.model.DemoInfoCache;
import packet.util.HttpResponse;
import packet.util.HttpsClient;
import packet.util.NotificationUtils;
...
public class HttpController {
    private static Logger logger = LoggerFactory.getLogger(HttpController.class.getName());
    ...
    private void initSpinner() {
        ...
        spinnerRoot.getStyleClass().add("register-others");
        ...
        scene.getStylesheets().add(HttpController.class
