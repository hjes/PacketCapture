...
import packet.control.ExtendedAnimatedFlowContainer;
...
public class MainController {
    ...
    public void init() throws FlowException {
        ...
        JavaFxObservable.actionEventsOf(test).subscribe(actionEvent -> {
            if (!(flowHandler.getCurrentView().getViewContext().getController() instanceof TestController)) {
                flowHandler.handle(test.getId());
                saveDisable.setValue(Boolean.TRUE);
            }
        });
        ...
        bindMenuToController(test, TestController.class, innerFlow);
