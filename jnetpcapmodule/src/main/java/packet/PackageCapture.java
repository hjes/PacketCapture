...
public class PackageCapture {
    ...
    public static void mainCapture(String interfaceName) {
        ...
        */
        ...
        packetHandler.setPcapDumper(dumper);
        packetHandler.setSenderDeviceName(interfaceName);//init sender device name
        packetHandler.start();
    ...
    public static void mainCapture(String args[]) {
        ...
        */
        ...
        PacketHandler<String> packetHandler = new PacketHandler<>();
        packetHandler.setPcapDumper(dumper);
        packetHandler.setSenderDeviceName(device.getName());//init sender device name
        packetHandler.start();
        pcap.loop(-1, packetHandler, "jNetP_cap rocks!");
